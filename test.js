...

{
    ...
    const Animal = Clazz('Animal', (Public, Protected, Private, _super) => ({
        constructor: function constructor() {
            console.log('about to call super constructor in Animal')
            _super(this).constructor() // Object
            console.log('done calling super constructor in Animal')
            this.blah = 'blahblah'
        },
    }))

    const Dog = Animal.subclass('Dog', (Public, Protected, Private, _super) => ({
        constructor: function constructor() {
            console.log('about to call super constructor in Dog')
            _super(this).constructor()
            console.log('done calling super constructor in Dog')
            this.foo = 'woo hoo'
        },
    }))
